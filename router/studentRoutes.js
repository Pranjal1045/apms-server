...
import {getStudentProject, submitProposal, uploadFiles, getAvailableSupervisors, getSupervisor, requestSupervisor, getMyRequests, getFeedback, getDashboardStats, downloadFile } from "../controllers/studentController.js";
...
upload.array("files",10),handleUploadError,
uploadFiles);
...
router.get("/my-requests", isAuthenticated, isAuthorized("Student"), getMyRequests);
